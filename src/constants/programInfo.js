...
export const leadContent = {
	...
	paragraph: `${schoolName} designs its program to provide students a foundation for a career in web development. ${schoolName} partners with Skills Fund to offer tuition${faq.costOfLiving
		? ' and cost of living'
...
export const programLoanInfo = [
	...
	{
		name: 'Module Four',
		url: 'https://my.skills.fund/application?lenderCode=SKFUZEM419',
		loanInfo: {
			// match loanInfo in first metro below
			maxLoanAmt: 2995,
			loanTerm36: true,
	...
	{
		name: 'Module Five',
		url: 'https://my.skills.fund/application?lenderCode=SKFUZEM519',
		loanInfo: {
			// match loanInfo in first metro below
			maxLoanAmt: 2995,
			loanTerm36: true,
...
export const programMaxText =
	"Choose the loan amount that works best for you. Borrow up to $18,495 for LearningFuze's Full-Immersion Bootcamp or up to $2,995 for tuition for each of LearningFuze's modules.";
