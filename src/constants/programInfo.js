...
export const schoolInfo = { // term details section
    ...
    APRRange36: '11.16 - 11.25%',
    APRRange60: '12.51 - 12.55%',
    interestOnly: [
        ...
        { // for multiple examples of interest only, add items to interestOnly array
            ...
            APR36: '11.25%',
            financeCharge36: '$663.61',
            IOPayment36: '$23.34',
            FullMonthlyPayment36: '$99.04',
            APR60: '12.55%',
            financeCharge60: '$1,181.57',
            IOPayment60: '$28.53',
            FullMonthlyPayment60: '$67.71',
            LoanExampleAmt: '$2,995',
            LoanExampleOFeeAmt: '$119.80',
            LoanExampleAmtPlusOFee: '$2,814.80',
...
export const leadContent = {
    ...
    paragraph: `${schoolName} designs its program to provide students a foundation for a career in web development. ${schoolName} partners with Skills Fund to offer tuition${faq.costOfLiving ? ' and cost of living' : ''} financing so more students like you can access their program.`
}
...
export const programLoanInfo = [ // update with program names and corresponding loan URLs with market segment code from Master Loan Parameters
    {
        ...
        url: "https://sf.privateloan.studentloan.org/external/LoanApplication.do?lenderCode=SKLFIM17",
    ...
    {
        name: "Module One",
        url: "https://sf.privateloan.studentloan.org/external/LoanApplication.do?lenderCode=SKFUZEM119",
        loanInfo: { // match loanInfo in first metro below
            maxLoanAmt: 2995,
            loanTerm36: true,
            loanTerm60: true,
    ...
    {
        name: "Module Two",
        url: "https://sf.privateloan.studentloan.org/external/LoanApplication.do?lenderCode=SKFUZEM219",
        loanInfo: { // match loanInfo in first metro below
            maxLoanAmt: 2995,
            loanTerm36: true,
            loanTerm60: true,
    ...
    {
        name: "Module Three",
        url: "https://sf.privateloan.studentloan.org/external/LoanApplication.do?lenderCode=SKFUZEM319",
        loanInfo: { // match loanInfo in first metro below
            maxLoanAmt: 2995,
            loanTerm36: true,
            loanTerm60: true,
    ...
    {
        name: "Module Four",
        url: "https://sf.privateloan.studentloan.org/external/LoanApplication.do?lenderCode=SKFUZEM419",
        loanInfo: { // match loanInfo in first metro below
            maxLoanAmt: 2995,
            loanTerm36: true,
            loanTerm60: true,
    ...
    {
        name: "Module Five",
        url: "https://sf.privateloan.studentloan.org/external/LoanApplication.do?lenderCode=SKFUZEM519",
        loanInfo: { // match loanInfo in first metro below
            maxLoanAmt: 2995,
            loanTerm36: true,
            loanTerm60: true,
...
export const programMaxText = "Choose the loan amount that works best for you. Borrow up to $18,495 for LearningFuze's Full-Immersion Bootcamp or up to $2,995 for tuition for each of LearningFuze's modules."
